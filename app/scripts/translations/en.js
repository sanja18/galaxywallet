...
NAV_ENS                     : 'ENS',
NAV_GenerateWallet          : 'Create New DBIX Account ',
NAV_Help                    : 'Help ',
NAV_InteractContract        : 'Interact with Contract ',
NAV_Multisig                : 'Multisig ',
NAV_MyWallets               : 'My Wallets ',
NAV_Offline                 : 'Send Offline ',
NAV_SendEther               : 'Send DBIX & Tokens ',
...
/* General */
x_Access                    : 'Access ',
x_AddessDesc                : 'You may know this as your "Account #" or your "Public Key". It is what you send people so they can send you DBIX. That icon is an easy way to recognize your address. ',
x_Address                   : 'Your Address ',
x_Cancel                    : 'Cancel ',
x_CSV                       : 'CSV file (unencrypted) ',
x_Download                  : 'Download ',
x_Json                      : 'JSON File (unencrypted) ',
x_JsonDesc                  : 'This is the unencrypted, JSON format of your private key. This means you do not need the password but anyone who finds your JSON can access your wallet & DBIX without the password. ',
x_Keystore                  : 'Keystore File (UTC / JSON · Recommended · Encrypted · Dbixwall Format) ',
x_Keystore2                 : 'Keystore File (UTC / JSON) ',
x_KeystoreDesc              : 'This Keystore / JSON file matches the format used by Dbixwall so you can easily import it in the future. It is the recommended file to download and back up. ',
...
/* Header */
CX_Tagline                  : 'Open Source JavaScript Client-Side Dbix Wallet Chrome Extension ',
...
MEW_Tagline                 : 'Open Source JavaScript Client-Side Dbix Wallet ',
MEW_Warning_1               : 'Always check the URL before accessing your wallet or creating a new wallet. Beware of phishing sites! ',

/* Footer */
FOOTER_1                    : 'Open-Source, client-side tool for easily &amp; securely interacting with the Dbix network. ',
...
sidebar_donation            : 'Galaxy is a free, open-source service dedicated to your privacy and security. The more donations we receive, the more time we spend creating new features, listening to your feedback, and giving you what you want. We are just two people trying to change the world. Help us? ',
...
ADD_Ledger_2                : 'Open the Dbix application (or a contract application) ',
...
ADD_Ledger_0a               : 'Re-open Galaxy on a secure (SSL) connection ',
ADD_Ledger_0b               : 'Re-open Galaxy using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/) ',
...
ADD_Radio_5_woTrezor        : '(Jaxx, Metamask) ',
ADD_Radio_5_withTrezor      : '(Jaxx, Metamask, TREZOR) ',
...
ADD_Warning_1               : 'You can add any account to "watch" on the wallets tab without uploading a private key. This does ** not ** mean you have access to this wallet, nor can you transfer DBIX from it. ',
ADD_Label_5                 : 'Enter the Address ',
ADD_Label_6                 : 'Unlock your Wallet ',
ADD_Label_6_short           : 'VIEW BALANCE ',
...
MYWAL_Content_3             : 'If you want to use this wallet with your Galaxy CX in the future, you will need to manually re-add it using the private key/JSON and password. ',
...
/* full sentence reads "You are about to send "10 DBIX" to address "0x1234". Are you sure you want to do this? " */
...
TRANS_warning               : 'If you are using the "Only DBIX" or "Only ETC" Functions you are sending via a contract. Some services have issues accepting these transactions. Read more. ',
TRANS_advanced              : '+Advanced: Add Data ',
TRANS_data                  : 'Data ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'A standard transaction using 21000 gas will cost 0.000441 DBIX. We use a slightly-above-minimum gas price of 0.000000021 DBIX to ensure it gets mined quickly. We do not take a transaction fee. ',
...
NODE_Warning                : 'Your node must be HTTPS in order to connect to it via Galaxy. You can [download the Galaxy repo & run it locally](https://github.com/ArabianChain/galaxywallet/releases/latest) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Node Name',
NODE_Port                   : 'Node Port',
...
SWAP_init_2                 : " for ", // "I want to swap my X DBIX for X BTC"
...
SWAP_progress_3             : "Received! ", // DBIX Received!
SWAP_progress_4             : "Sending your {{orderResult.output.currency}} ",
SWAP_progress_5             : "Order Complete ",
SWAP_order_CTA              : "Please send ", // Please send 1 DBIX...
SWAP_unlock                 : "Unlock your wallet to send DBIX or Tokens directly from this page. ",
...
/* View Wallet Details */
VIEWWALLET_Subtitle         : 'This allows you to download different versions of private keys and re-print your paper wallet. You may want to do this in order to [import your account into Dbixwall](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). You can simply do that - copy Keystore File and paste it into .dubaicoin/Keystore folder. If you want to check your balance, we recommend using a blockchain explorer like [dbixscan.io](http://dbixscan.io/). ',
...
ERROR_17                    : 'You need to have **0.01 DBIX** in your account to cover the cost of gas. Please add some DBIX and try again. ',
...
ERROR_28                    : '**You need your Keystore File & Password** (or Private Key) to access this wallet in the future. Please save & back it up externally! There is no way to recover a wallet if you do not save it. Read the [help page](https://dbix.io/#help) for instructions. ',
...
HELP_Desc                   : 'Do you see something missing? Have another question? [Get in touch with us](info@arabianchain.org), and we will not only answer your question, we will update this page to be more useful to people in the future! ',
HELP_Remind_Title           : 'Some reminders ',
HELP_Remind_Desc_1          : '**Dbix, Galaxy & Galaxy CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your DBIX to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost DBIX**. ',
HELP_Remind_Desc_2          : 'Galaxy & Galaxy CX are not "web wallets". You do not create an account or give us your DBIX to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain ',
...
HELP_0_Desc_1               : 'Galaxy gives you the ability to generate new wallets so you can store your DBIX yourself, not on an exchange. This process happens entirely on your computer, not our servers. Therefore, when you generate a new wallet, **you are responsible for safely backing it up**. ',
...
HELP_0_Desc_5               : 'Transfer DBIX to this new wallet. ',

HELP_1_Title                : '1) How do I create a new wallet? ',
HELP_1_Desc_1               : 'Go to the "Create New DBIX Account" page. ',
HELP_1_Desc_2               : 'Go to the "Add Wallet" page & select "Create New DBIX Account" ',
...
HELP_1_Desc_4               : 'Click "Create New DBIX Account". ',
HELP_1_Desc_5               : 'Your wallet has now been generated. ',

HELP_2a_Title               : '2) How do I save/backup my wallet? ',
...
HELP_2a_Desc_2              : 'Save the address. You can keep it to yourself or share it with others. That way, others can transfer DBIX to you. ',
HELP_2a_Desc_3              : 'Save versions of the private key. Do not share it with anyone else. Your private key is necessary when you want to access your DBIX to send it! There are 3 types of private keys ',
...
HELP_2b_Title               : '3) How do I safely / offline / cold storage with Galaxy? ',
HELP_2b_Desc_1              : 'Go to [https://github.com/ArabianChain/galaxywallet/releases/latest](https://github.com/ArabianChain/galaxywallet/releases/latest). ',
...
HELP_3_Title                : '4) How do I verify I have access to my new wallet? ',
HELP_3_Desc_1               : '**Before you send any DBIX to your new wallet**, you should ensure you have access to it. ',
HELP_3_Desc_2               : 'Navigate to the "View Wallet Info" page. ',
HELP_3_Desc_3               : 'Navigate to the Galaxy "View Wallet Info" page. ',
...
HELP_3_Desc_8               : 'If you are planning on holding a large amount of DBIX, we recommend that send a small amount of DBIX from new wallet before depositting a large amount. Send .001 DBIX to your new wallet, access that wallet, send that .001 DBIX to another address, and ensure everything works smoothly. ',

HELP_4_Title                : '5) How do I send DBIX from one wallet to another? ',
...
HELP_4_Desc_2               : 'Navigate to the "Send DBIX & Tokens" page. ',
...
HELP_4CX_Title              : '4) How do I send DBIX using Galaxy CX? ',
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Send DBIX & Tokens" page. ',
...
HELP_4CX_Desc_12            : 'Using "Send DBIX & Tokens" Page ',

HELP_5_Title                : '6) How do I run Galaxy offline/locally? ',
HELP_5_Desc_1               : 'You can run Galaxy on your computer instead of from the GitHub servers. You can generate a wallet completely offline and send transactions from the "Offline Transaction" page. ',
HELP_5_Desc_7               : 'Galaxy is now running entirely on your computer. ',
HELP_5_Desc_8               : 'In case you are not familiar, you need to keep the entire folder in order to run the website, not just `index.html`. Don\'t touch or move anything around in the folder. If you are storing a backup of the Galaxy repo for the future, we recommend just storing the ZIP so you can be sure the folder contents stay intact. ',
HELP_5_Desc_9               : 'As we are constantly updating Galaxy, we recommend you periodically update your saved version of the repo. ',
...
HELP_7_Desc_8               : 'Enter the address, name, and decimals of the token. These are provided by the developers of the token. ',
...
HELP_8_Title                : '9) What happens if your site goes down? ',
HELP_8_Desc_1               : 'Galaxy is not a web wallet. You don\'t have a login and nothing ever gets saved to our servers. It is simply an interface that allows you interact with the blockchain. ',
HELP_8_Desc_2               : 'If Galaxy goes down, you would have to find another way (like Dbixwall) to do what we are doing. But you wouldn\'t have to "get" your DBIX out of Galaxy because it\'s not in Galaxy. It\'s in whatever wallet your generated via our site. ',
HELP_8_Desc_3               : 'You can import your unencrypted private key directly into gdbix / Dbixwall very easily now. See question #12 below. ',
HELP_8_Desc_4               : 'In addition, the likelihood of us taking Galaxy down is slim to none. It costs us almost nothing to maintain as we aren\'t storing any information. If we do take the domain down, it still is, and always will be, publicly available at [https://github.com/ArabianChain/galaxywallet](https://github.com/ArabianChain/galaxywallet/tree/gh-pages). You can download the ZIP there and run it locally. ',

HELP_8CX_Title              : '8) What happens if Galaxy CX disappears? ',
...
HELP_8CX_Desc_2             : 'That said, it is **very important** that you back up all your information for any new wallets generated with Galaxy CX. That way if anything happens to Galaxy CX or your computer, you still have all the information necessary to access your DBIX. See the #2a for how to back up your wallets. ',
HELP_8CX_Desc_3             : 'If for some reason Galaxy CX disappears from the Chrome Store, you can find the source on Github and load it manually. See #5 above. ',

HELP_9_Title                : '10) Is the "Send DBIX & Tokens" page offline? ',
...
HELP_10_Title               : '11) How do I make an offline transaction? ',
...
HELP_10_Desc_11             : 'On your online computer, paste the signed transaction into the text field in step #3 and click "SEND DBIX". This will broadcast your transaction. ',

HELP_12_Title               : '12) How do I import a wallet created with Galaxy into Dbixwall? ',
HELP_12_Desc_1              : 'Using an Dbixwall JSON file from Galaxy v2+.... ',
...
HELP_12_Desc_5              : 'Select the wallet you want to import into Dbixwall, click the "View" icon, enter your password, and access your wallet. ',
HELP_12_Desc_6              : 'Find the "Download JSON file - Dbixwall Format (encrypted)" section. Press the "Download" button below that. You now have your keystore file. ',
HELP_12_Desc_7              : 'Open the Dbixwall application. ',
...
HELP_12_Desc_19             : 'Open terminal and run the following command: `gdbix account import ~/Desktop/nothing_special_delete_me.txt` ',
HELP_12_Desc_20             : 'This will prompt you to make a new password. This is the password you will use in gdbix / Dbixwall whenever you send a transaction, so don\'t forget it. ',
HELP_12_Desc_21             : 'After successful import, delete `nothing_special_delete_me.txt` ',
HELP_12_Desc_22             : 'The next time you open the Dbix Wallet application, your account will be listed under "Accounts". ',
HELP_12_Desc_23             : 'Open Notepad & paste the private key ',
HELP_12_Desc_24             : 'Save the file as `nothing_special_delete_me.txt` at `C:` ',
HELP_12_Desc_25             : 'Run the command, `gdbix account import C:\\nothing_special_delete_me.txt` ',
HELP_12_Desc_26             : 'This will prompt you to make a new password. This is the password you will use in gdbix / Dbixwall whenever you send a transaction, so don\'t forget it. ',
HELP_12_Desc_27             : 'After successful import, delete `nothing_special_delete_me.txt` ',
HELP_12_Desc_28             : 'The next time you open the Dbixwall application, your account will be listed under "Accounts". ',

HELP_13_Title               : '13) What does mean "Insufficient funds. Account you try to send transaction from does not have enough funds. Required XXXXXXXXXXXXXXXXXXX and got: XXXXXXXXXXXXXXXX." ? ',
HELP_13_Desc_1              : 'This means you do not have enough DBIX in your account to cover the cost of gas. Each transaction (including token and contract transactions) require gas and that gas is paid in DBIX. The number displayed is the amount required to cover the cost of the transaction in Wei. Take that number, divide by `1000000000000000000`, and subtract the amount of DBIX you were trying to send (if you were attempting to send DBIX). This will give you the amount of DBIX you need to send to that account to make the transaction. ',

HELP_14_Title               : '14) Some sites randomize (seed) the private key generation via mouse movements. Galaxy doesn\'t do this. Is the random number generation for Galaxy safe? ',
HELP_14_Desc_1              : 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experiments) believe in window.crypto. In addition, Galaxy can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',

HELP_15_Title               : '15) Why hasn\'t the account I just created show up in the blockchain explorer? (ie: dbixchain, dbixscan) ',
HELP_15_Desc_1              : 'Accounts will only show up in a blockchain explorer once the account has activity on it&mdash;for example, once you have transferred some DBIX to it. ',

HELP_16_Title               : '16) How do I check the balance of my account? ',
HELP_16_Desc_1              : 'You can use a blockchain explorer like [dbixscan.io](http://dbixscan.io/). Paste your address into the search bar and it will pull up your address and transaction history.',

HELP_17_Title               : '17) Why isn\'t my balance showing up when I unlock my wallet? ',
HELP_17_Desc_1              : ' This is most likely due to the fact that you are behind a firewall. The API that we use to get the balance and convert said balance is often blocked by firewalls for whatever reason. You will still be able to send transactions, you just need to use a different method to see said balance, like dbixscan.io ',

HELP_18_Title               : '18) Where is my gdbix wallet file? ',

HELP_19_Title               : '19) Where is my Dbixwall file? ',
HELP_19_Desc_1              : 'Dbixwall files are typically found in the file locations above. ',
...
HELP_21_Desc_8              : 'Of course, this all assumes that keys are generated in a truly random way & with sufficient entropy. The keys generated here meet that criteria, as do Jaxx and Fusion/geth. The Ethereum wallets are all pretty good. Keys generated by brainwallets do not, as a person\'s brain is not capable of creating a truly random seed. There have been a number of other issues regarding lack of entropy or seeds not being generated in a truly random way in Bitcoin-land, but that\'s a separate issue that can wait for another day. ',

HELP_SecCX_Title            : 'Security - Galaxy CX ',
...
HELP_SecCX_Desc_6           : 'If we were to encrypt these items, you would need to enter a password each time you wanted to view your account balance or view the nicknames. If this concerns you, we recommend you use Galaxy instead of this Chrome Extension. ',
...
HELP_Sec_Desc_3             : 'We aren\'t going to take your money or steal your private key(s). There is no malicious code on this site. In fact the "Create New DBIX Account" pages are completely client-side. That means that all the code is executed on ** your computer** and it is never saved and transmitted anywhere. ',
HELP_Sec_Desc_4             : 'Check the URL -- This site is being served through GitHub and you can see the source code here: [https://github.com/ArabianChain/galaxywallet/tree/gh-pages](https://github.com/ArabianChain/galaxywallet/tree/gh-pages) to [https://dbix.io](https://dbix.io). ',
HELP_Sec_Desc_5             : 'For generating wallets, you can download the [source code and run it locally](https://https://github.com/ArabianChain/galaxywallet/releases/latest). See #5 above. ',
